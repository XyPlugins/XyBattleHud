...
public final class PickupAnimationSettings {
    ...
    private PickupAnimationSettings(FileConfiguration config) {
        ...
        fadeInMillis = clamp(config.getInt("pickup.animation.fade-in-millis", 150), 0, durationMillis);
        ...
        stackSpacing = clamp(config.getInt("pickup.animation.stack-spacing", 34), 1, 200);
